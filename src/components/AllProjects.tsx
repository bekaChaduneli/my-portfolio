          ...
          return (
            ...
            >
              <Flex
                ...
                borderRadius={{ sm: "4px", md: "10px", lg: "12px", xl: "15px" }}
                minW={{ sm: "130px", md: "265px", lg: "360px", xl: "430px" }}
                ...
                {isHovered ? (
                  <>
                    ...
                    >
                      ...
                      <Box
                        w={"80%"}
                        mt={{ sm: "6px", md: "12px", lg: "20px", xl: "30px" }}
                        display={"flex"}
                        gap={{ sm: "5px", md: "8px", lg: "12px", xl: "20px" }}
                      ...
                      >
                        <Box
                          ...
                          justifyContent={"center"}
                          w={"100%"}
                          h={{ sm: "12px", md: "20px", lg: "25px", xl: "30px" }}
                        >
